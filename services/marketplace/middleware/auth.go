...
func AuthRequired() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		user, err := verifyCognitoToken(token)
		if err != nil {
...
func CreatorOnly() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if user.UserType != "creator" && !isInGroup(user.Groups, "creators") {
...
func AdminOnly() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if user.UserType != "admin" && !isInGroup(user.Groups, "admins") {
...
func GetUserIDFromContext(c *gin.Context) (string, bool) {
	userID, exists := c.GetString("userID")
