...
- Name: Consumer Subscription Journey >> API Discovery & Subscription >> should handle failed payment
- Location: /Users/patrickgloria/Desktop/CLI-API-Marketplace/testing/e2e/tests/consumer-flows/subscription-journey.spec.ts:123:9
...
Call log:
  - waiting for locator('[data-testid="login-button"]')
    ...
    at /Users/patrickgloria/Desktop/CLI-API-Marketplace/testing/e2e/tests/consumer-flows/subscription-journey.spec.ts:63:18
```
