...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/creator-portal
Call log:
  - navigating to "http://localhost:3001/creator-portal", waiting until "load"

    at /Users/patrickgloria/Desktop/CLI-API-Marketplace/testing/e2e/tests/creator-flows/earnings-payout.spec.ts:15:16
```
